  ...
  persist(
    (set, get) => ({
      ...
      quests: [
        ...
        { id: 3, title: 'Tương tác mạng nội bộ', desc: 'Thắp lửa hoặc comment 3 bài viết.', exp: 15, credits: 3, progress: 0, target: 3, status: 'pending', subCategory: 'Social', rarity: 'common', tabId: 'daily' },
