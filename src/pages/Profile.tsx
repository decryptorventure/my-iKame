                ...
                <div className="space-y-6">
                    ...
                    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }}
                        ...
                        <div className="space-y-4">
                            {[
                                { icon: '🔥', label: '7 Ngày Chuyên Cần', date: 'Đạt được ngày 20/02' },
                                { icon: '🚀', label: 'Siêu Chiến Binh OKR', date: 'Đạt được ngày 15/01' },
                                { icon: '🤝', label: 'Đồng Nghiệp Thân Thiện', date: 'Đạt được ngày 05/01' },
                            ].map((badge, i) => (
                                <div key={i} className="flex items-center gap-3 group cursor-pointer">
                                    <div className="w-10 h-10 bg-slate-50 rounded-xl flex items-center justify-center text-xl border border-slate-100 group-hover:bg-brand-50 group-hover:border-brand-100 transition-all">
                                        {badge.icon}
                                    </div>
                                    <div>
                                        <p className="font-bold text-sm text-slate-800 group-hover:text-brand-600 transition-colors">{badge.label}</p>
